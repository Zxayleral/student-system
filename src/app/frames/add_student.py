...
class AddStudent(tk.Frame):
	def __init__(self, master):
		...
		self.student_gender = None

		# ADD COURSE LABEL
		self.add_course_label = tk.Label(self, text="Add Student", 
		...
		self.gender_label = tk.Label(self, text="Gender:", font=('Default', 13),
										  bg=color.PEACH, fg=color.CHARCOAL).place(relx=0.254, rely=0.6, anchor=tk.CENTER)

		self.gender_entry = ttk.Combobox(self, 
			width=18, font=('Default', 13))
		...
		self.gender_entry.place(relx=0.5, rely=0.6, anchor=tk.CENTER)
